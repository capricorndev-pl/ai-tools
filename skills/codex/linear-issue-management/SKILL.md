...
description: Create well-structured Linear issues or triage items from repo, product, bug, audit, or planning context. Use when Codex needs to file new Linear work, decide between implementation issue vs triage, choose project/category/priority, write consistent Linear descriptions, or update issue metadata for Linear audit trails.
---
...
1. Read enough context to understand the requested work: user message, current repo, relevant `AGENTS.md`, active OpenSpec change, recent commits, logs, screenshots, SQL evidence, or linked issue.
...
- Repository instructions in `AGENTS.md` or local workflow docs are next.
